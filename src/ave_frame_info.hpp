//ave_frame_info.h is for passing frame-specific information to various parts of the rendering engine.
...
// frames are managed in file ave_swap_chain.h
...
#define MAX_LIGHTS 10
	...
	struct FrameInfo {
		...
		AveCamera& camera; //reference to the camera
		VkDescriptorSet globalDescriptorSet; //descriptor set for global UBO
		AveGameObject::Map& gameObjects; //reference to the map of game objects
	};
}