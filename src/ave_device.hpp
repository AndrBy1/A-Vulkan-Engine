...
* 
* AveDevice is a class that encapsulates the Vulkan device and related functionalities, such as creating buffers, command pools, and managing memory. 
...
namespace ave {
    ...
    class AveDevice {
        ...
        //operator is a special function that is called when an object is assigned a new value from another existing object, in this case, it prevents copying of AveDevice objects
