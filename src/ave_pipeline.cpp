...
//The pipeline is an object that bundles together all of the GPU's fixed and programmable state needed for drawing or computing. A blueprint that tells GPU how to process input data and produce final output
//
...
namespace ave{
    ...
    void AvePipeline::defaultPipelineConfigInfo(PipelineConfigInfo& configInfo) {
        ...
        configInfo.bindingDescriptions = AveModel::Vertex::getBindingDescriptions();
