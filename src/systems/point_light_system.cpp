...
namespace ave {
	...
	void PointLightSystem::createPipeline(VkRenderPass renderPass) {
		...
		//this is creating a unique pointer to a avePipeline object. 
		// unique pointer because we want to ensure that there is only one owner of the avePipeline object
	...
	void PointLightSystem::render(FrameInfo& frameInfo) {
		// sort lights
		std::map<float, AveGameObject::id_t> sorted;
		for (auto& kv : frameInfo.gameObjects) {
			auto& obj = kv.second;
			if (obj.pointLight == nullptr) continue;
